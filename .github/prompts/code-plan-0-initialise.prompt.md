...
# code-plan-0-initialise (alias: phase-0-constitution)
...
If the user input is empty, ask the user for the following information:
- What are the guiding principles for this project? (List of concise statements with rationale). Focus on the what and why.
- What is the quality and verification strategy if any? (How does the team prove changes are safe to release?)
- What are the delivery practices? (Planning cadence, documentation expectations, definition of done)
- What is the governance model? (Amendment procedure, review cadence, compliance tracking)
